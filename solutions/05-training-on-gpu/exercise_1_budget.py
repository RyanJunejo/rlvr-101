"""
ANSWER KEY -- Unit 05, Lab 1 — what will this run cost?
...
def affordable_steps(
    ...
    if seconds_per_step <= 0:
        return 0
    cost_per_step = hourly_rate(num_gpus, rate_per_gpu) / 3600.0 * seconds_per_step
    # `//` here would return 1249 for budget=50, cost=0.04 -- see the docstring.
    return int(budget / cost_per_step + 1e-9)

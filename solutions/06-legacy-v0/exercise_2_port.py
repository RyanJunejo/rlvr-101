"""
ANSWER KEY -- Unit 06, Lab 2 — port a v0 environment to v1.
...
class MathTask(v1.Task[MathData, v1.State, v1.TaskConfig]):
    ...
    @v1.reward
    async def correct_answer(self, task: MathData, trace: v1.Trace) -> float:
        # Identical logic to the v0 function, minus the empty-list guard --
        # trace.last_reply already returns "" when nothing was sampled.

"""
Lab 2 — reading a training config.
...
def summarize(cfg: dict) -> dict:
    ...
    return todo("summarize: pull model, steps, batch/group size, gpus, taskset, lr")
...
def validate(cfg: dict) -> list[str]:
    ...
    return todo("validate: check group_size, gpu count, learning rate, group_size upper bound")

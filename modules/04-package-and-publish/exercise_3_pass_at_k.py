"""
Lab 3 — pass@k, and why it decides whether a task is trainable.
...
def pass_at_k(n: int, c: int, k: int) -> float:
    ...
    """
    # TODO: implement the formula, handling k > n.
    return todo("pass_at_k: 1 - comb(n-c, k) / comb(n, k)")
...
def naive_pass_at_k(samples_correct: np.ndarray, k: int, rng: np.random.Generator) -> float:
    ...
    Returns:
        1.0 or 0.0
    """
    # TODO: draw k without replacement, return 1.0 if any is correct.
    return todo("naive_pass_at_k: draw k without replacement, 1.0 if any correct")

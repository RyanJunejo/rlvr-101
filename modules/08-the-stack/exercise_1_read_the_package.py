"""
Lab 1 — read the package as a map of the company.
...
def list_plugins(package) -> list[str]:
    ...
    """
    # TODO: implement with pkgutil.iter_modules.
    return todo("list_plugins: sorted submodule names via pkgutil.iter_modules")
...
def runtime_kinds() -> list[str]:
    ...
    """
    # TODO: implement by inspecting dir(runtimes).
    return todo("runtime_kinds: <Kind>Config names, minus the base and the policy")
...
def classify(harness: str) -> str:
    ...
    return todo("classify: map a harness id to trivial/coding/browser/research/plumbing")
